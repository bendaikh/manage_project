          ...
          <form @submit.prevent="updateRole()">
            ...
            <div class="mb-4">
              ...
              <div class="space-y-3 max-h-96 overflow-y-auto border border-gray-200 rounded-md p-4">
                ...
                <!-- Dynamic Sections -->
                <div 
                  v-for="section in ['roles', 'orders', 'products', 'categories', 'warehouses', 'stock', 'shipments', 'invoices', 'accounting', 'reports', 'support', 'settings']" 
                  :key="section"
...
const getPermissionsBySection = (section) => {
  const sectionMappings = {
    ...
    'support': ['view_support_tickets', 'create_support_tickets', 'respond_to_tickets', 'manage_support_tickets'],
